...
class Dimensions:
    ...
    def compute_width_height(self, focal_length = 3.37, return_mat = False):
        ...
        with dai.Device(self._pipeline) as device:
            ...
            width, height, orig, (tltrX, tltrY, trbrX, trbrY), (topLeft, bottomRight) = bm.get_bbox_width_height_pxl(frame)
            ...
            spatials, centroid = hostSpatials.calc_spatials(depthFrame, [int(topLeft[0]), int(topLeft[1]), int(bottomRight[0]), int(bottomRight[1])]) # centroid == x/y in our case
